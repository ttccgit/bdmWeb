...
angular.module('webApp').controller('logOuterrContrl', ['$scope', 'logOuterrservice', function ($scope, logOuterrservice) {
    ...
    var loadCuts = function () {
        logOuterrservice.getLogOuterrs($scope.queryWhere).then(function (response) {
            $scope.logOutErr = response.Items;
